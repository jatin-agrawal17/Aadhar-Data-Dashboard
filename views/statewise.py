...
def page():
 ...
 'West Bengal']
    ...
    "considering only districts with ≥30% reporting coverage to ensure comparability.**"
)
    ...
    with tab4:
        ...
        st.markdown(
            ...
            "groups (0–5, 5–17, and 18+ years) using reported days only.**"
        )
